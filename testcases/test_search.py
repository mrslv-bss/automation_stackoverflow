...
def test_search_functionality_users_page(get_driver):
    open_users_page_and_search(get_driver, "bass_")


def test_search_functionality_tags_page(get_driver):
    open_tags_page_and_search(get_driver, "go")


def test_search_functionality_companies_page_location(get_driver):
    open_companies_page_and_search_by_location(get_driver, "ukraine")


def test_search_functionality_companies_page_name(get_driver):
